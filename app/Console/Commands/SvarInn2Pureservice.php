        ...
        if ($msgCount > 0):
            ...
            foreach ($msgs as $message):
                ...
                if ($email === false):
                     ...
                     */
                    $email = Arr::get($message,'svarSendesTil.orgnr') != null ? Arr::get($message,'svarSendesTil.orgnr').'.no_email@pureservice.local' : Str::random(16).'.no_email@pureservice.local';
                endif;
